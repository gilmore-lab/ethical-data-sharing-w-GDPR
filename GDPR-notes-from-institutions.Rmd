...
As you may be aware the EU General Data Protection Regulation (GDPR) is soon to come into force to attach stricter controls onto the distribution of personal data that originates within the EU. As it is our understanding that personal data will be contained in the recordings Catherine is proposing to upload to Databrary, we are now in a position where we need to ensure that such does not infringe GDPR.
